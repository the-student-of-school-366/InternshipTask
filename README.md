...
- Странно что в openapi.yml есть описание сущностей, которые не описаны в README и очень похожи на DTO, но при этом они имеют странные названия вроде PullRequestShort.
